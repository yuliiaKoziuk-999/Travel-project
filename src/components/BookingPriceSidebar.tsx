import heroThumb from '../assets/img/flight-detail-hero.jpg'
...
export default function BookingPriceSidebar() {
  return (
    <aside className="h-fit rounded-xl bg-white p-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <p className="text-base font-medium text-ink">Economy</p>
          <p className="mt-1 text-xl font-semibold text-ink">Emirates A380 Airbus</p>

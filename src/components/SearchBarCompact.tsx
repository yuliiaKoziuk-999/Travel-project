...
const fields: Field[] = [
  { label: 'From - To', value: 'Lahore - Karachi', trailingIcon: iconSwap, wide: true },
  { label: 'Trip', value: 'Return', trailingIcon: iconChevronDown },
  { label: 'Depart- Return', value: '07 Nov 22 - 13 Nov 22', wide: true },
  { label: 'Passenger - Class', value: '1 Passenger, Economy', wide: true },
]
    ...
    <div className="rounded-2xl bg-white p-6 sm:p-8">
      <div className="flex flex-wrap items-end gap-4">
        {fields.map((field) => (
          <label
            key={field.label}
            className={`relative flex h-14 flex-1 items-center rounded border border-black/30 px-4 ${
              field.wide ? 'min-w-[220px]' : 'min-w-[140px]'
            }`}
          >

...
import HotelVoucherTicket from '../components/HotelVoucherTicket'
      ...
      <Container>
        ...
        <div className="mt-6 flex flex-wrap items-start justify-between gap-6">
          <div>
            ...
            <p className="mt-2 text-sm font-medium text-ink">Booking confirmed — enjoy your stay!</p>
          </div>
          <p className="text-3xl font-bold text-ink">$325</p>
        </div>
        ...
        <div className="mt-14 pb-16">
          ...
          <div className="mt-6">
            ...
            <p className="mt-4 text-sm text-ink">
              If you are purchasing your stay using a debit or credit card via the Website, we
            ...
            <p className="mt-4 text-sm text-ink">
              ...
              or at the time of check-in. Golobe reserves the right to deny check-in or to collect
              a guarantee payment (in cash or from another credit card) if the card originally
              used for the purchase cannot be presented by the cardholder at check-in, or in the
              case the original payment has been withheld or disputed by the card issuing bank.
